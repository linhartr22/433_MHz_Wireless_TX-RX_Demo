This project implements VirtualWire Receiver communication and reads a local DHT11 sensor. These examples can be used to implement an Arduino Thermostat with wireless remote temperature sensors.
