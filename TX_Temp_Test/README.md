This project implements VirtualWire Transmitter communication and transmits DHT11 sensor data. These examples can be used to implement an Arduino Thermostat with wireless remote temperature sensors.
